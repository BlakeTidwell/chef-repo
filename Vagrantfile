...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "cheftidwell-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/l303media"
  #   chef.validation_client_name = "l303media-validator"
  #   chef.validation_key_path = ".chef/l303media-validator.pem"
  # end
end
